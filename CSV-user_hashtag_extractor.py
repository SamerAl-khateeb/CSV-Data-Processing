...
#"User-Hashtag-Network.csv" generated 
    ...
    for row in CSV_file_as_list:
      ...
      for eachHashtag in jsonColumnData["hashtags"]:
        ...
        with open('User-Hashtag-Network.csv', 'w', newline='', encoding='utf-8') as csv_output_file:
          ...
          csvwriter.writerow(["source", "text", "relationship_type", "relation_date", "relation_time", "user_followers_count", "user_friends_count", "hashtag"])
          
          #creating a list of values (a row) 
          CSV_output_row = [from_user, text, relationship_type, relation_date, relation_time, user_followers_count, user_friends_count, eachHashtag["text"]]
